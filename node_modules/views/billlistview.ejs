			...
			<div  class="card-1" style="overflow:scroll;background:white;">
				<table id="" class="ex1" cellspacing="0" width="100%">
					<tr>
						...
						<td style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="http://127.0.0.1:3000/refreshbills?bill_status=none">Refresh</a></td>
					</tr>
				</table>
				<table id="" class="display ex1" cellspacing="0" width="100%">
					...
					<tbody>
						  <% for(var i=0;i<contentlength;i++) { %>	
							<tr>
								<td><a style="color: blue;" href="http://127.0.0.1:3000/billview?bill_ns_id=<%= tran_id[i]%>"><%=tran_id[i]%></a></td>
								<td><%=tran_date[i]%></td>
								<td style="text-align: right;"><%=tran_amount[i]%></td>
								<td style="text-align: right;"><%=tran_memo[i]%></td>
							</tr>					 
						  <% } %>
					</tbody>
				</table>
