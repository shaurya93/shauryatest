        ...
        <div id="advert3" align="left" style="background-image:url(img10.png); color:#0D47A1;">     
			...
			<div class="card-1" style="background-color:white; overflow:scroll;">
				<table id="" class="ex1" cellspacing="0" width="100%">
					<tr>
							<td colspan="3" style="font-size: 18pt; font-weight:bold; color: black; text-align:left;"><%= title%> List</td>
							<td style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="http://127.0.0.1:3000/refresh?record_type=PurchaseOrder&po_status=<%= statuspo%>">Refresh</a></td>
					</tr>
				</table>
				<table id="" class="display ex1" cellspacing="0" width="100%" >
					...
					<tbody>
						 <% for(var i=0;i<contentlength;i++) { %>	
							<tr>
								<td><a style="color: blue;" href="http://127.0.0.1:3000/poview?po_ns_id=<%= tran_id[i]%>"><%=tran_no[i]%></a></td>
								<td><%=tran_date[i]%></td>
								<td><%=tran_status[i]%></td>
