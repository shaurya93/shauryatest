...
<body style="background-image:url(img10.png);">
    ...
    <main >
        ...
        <span id="spanclass" style="color:#0D47A1;" class="btn-default">&nbsp;</span>				
			<div  class="transparent" style="background:white;">
				<table width="100%" border="0" style="font-family: Arial, Helvetica; font-size: 9pt; background: white;">
					<tr style="background-image:url(img10.png);">
						<td colspan="4" style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="http://127.0.0.1:3000/refreshbills?record_type=Bills&bill_status=single&bill_id=<%= bill_internal_id%>">Refresh</a> <a  class="btn btn-primary btn-sm" href="http://127.0.0.1:3000/billlistview">List</a></td>
					</tr>
					<tr>
					<!-- colspan="6" -->
				...
				<table id="" class="display" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: right;"><%= (items[i].tax_amt_val+items[i].amount_val) %></td>
						</tr>
						<% total_amt+=items[i].amount_val; %>
						<% total_tax+= items[i].tax_amt_val; %>
						
						<% } %>
						<% total= parseInt(total_tax)+parseInt(total_amt); %>
						 <% }%>
					</tbody>
			...
			<table width="100%" border="0" style="font-family: Arial, Helvetica; font-size: 9pt; background: white;">
				<tr style="background-image:url(img10.png);">
					<td colspan="6" style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="http://127.0.0.1:3000/refreshbills?record_type=Bills&bill_status=single&bill_id=<%= bill_internal_id%>">Refresh</a> <a  class="btn btn-primary btn-sm" href="http://127.0.0.1:3000/billlistview">List</a></td>
				</tr>
			</table>
			</div>
		</div>
