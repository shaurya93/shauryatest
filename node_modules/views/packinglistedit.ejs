	...
	<form method='POST'>
			<table  width="100%" border="0" style="font-family: Arial, Helvetica; font-size: 9pt; align-content: center; background: white;">
				...
				<tr>
					...
					<td  valign="top" ><input  type="date" name="shipdate" id="shipdate" value="<%= ship_to_date%>" required/></td>
				...
				<table id="pl_items" class="display" cellspacing="0" width="100%">
					...
					<tbody>
							...
							<tr>
								...
								<td><input  type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="quantitydispatched<%= i%>" id="quantitydispatched<%= i%>" value="<%= items[i].qty_dispatched_val %>" onchange="validate_quantity(this)" required/></td>
								...
								<td><input  type="text" onkeypress="if (event.charCode != 46 && event.charCode > 31 && (event.charCode < 48 || event.charCode > 57))return false;return true;" name="netweight<%= i%>" value="<%= items[i].netwt_val %>"/></td>
								<td><input  type="text" onkeypress="if (event.charCode != 46 && event.charCode > 31 && (event.charCode < 48 || event.charCode > 57))return false;return true;" name="grossweight<%= i%>" value="<%= items[i].grosswt_val %>"/></td>
